...
RSpec.describe TasklistsController, type: :controller do
  ...
  describe "GET #index" do
    it "assigns all tasklists as @tasklists" do
      ...
      expect(assigns(:tasklists)).to eq([tasklist])
    end
  end
  ...
  describe "GET #show" do
    it "assigns the requested tasklist as @tasklist" do
      ...
      expect(assigns(:tasklist)).to eq(tasklist)
    end
  end
  ...
  describe "GET #new" do
    it "assigns a new tasklist as @tasklist" do
      ...
      expect(assigns(:tasklist)).to be_a_new(Tasklist)
    end
  end
  ...
  describe "POST #create" do
    context "with valid params" do
      ...
      it "assigns a newly created tasklist as @tasklist" do
        post :create, {:tasklist => valid_attributes}, valid_session
        expect(assigns(:tasklist)).to be_a(Tasklist)
        expect(assigns(:tasklist)).to be_persisted
      end
    ...
    context "with invalid params" do
      it "assigns a newly created but unsaved tasklist as @tasklist" do
        post :create, {:tasklist => invalid_attributes}, valid_session
        expect(assigns(:tasklist)).to be_a_new(Tasklist)
      end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested tasklist" do
        tasklist = Tasklist.create! valid_attributes
        put :update, {:id => tasklist.to_param, :tasklist => new_attributes}, valid_session
        tasklist.reload
      ...
      it "redirects to the tasklist" do
        tasklist = Tasklist.create! valid_attributes
        put :update, {:id => tasklist.to_param, :tasklist => valid_attributes}, valid_session
        expect(response).to redirect_to(tasklist)
      end
    end
    ...
    context "with invalid params" do
      it "assigns the tasklist as @tasklist" do
        tasklist = Tasklist.create! valid_attributes
        put :update, {:id => tasklist.to_param, :tasklist => invalid_attributes}, valid_session
        expect(assigns(:tasklist)).to eq(tasklist)
      end
  ...
  describe "DELETE #destroy" do
    ...
    it "redirects to the tasklists list" do
      tasklist = Tasklist.create! valid_attributes
      delete :destroy, {:id => tasklist.to_param}, valid_session
      expect(response).to redirect_to(tasklists_url)
    end
  end
